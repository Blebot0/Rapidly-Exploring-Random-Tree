...
class RRT_Planner():
    ...
    def __init__(self, start_point = None, end_point = None, obstacle_loc = None, min_dis = None, max_dis = None, length = None, goal_radius = None):
        

        ## DEFINING START AND END NODES OF THE ALGORITHM
        self.start_point = Node(start_point[0], start_point[1])
        self.end_point = Node(end_point[0], end_point[1])

        ## GOAL AREA HAS BEEN SET TO DIRECT THE VICINTY OF THE ACTUAL GOAL, INCREASING GOAL AREA MAY LEAD TO PREMATURE COMPLETITION OF THE ALGORITHM
        self.goal_area = (end_point[0], end_point[1], goal_radius)

        ## LOCATION OF ALL THE OBSTAACLES
        self.obstacle_loc = obstacle_loc
            
        ## FINAL PATH AND MINIMUM AND MAX DISTANCE FOR THE AREA TO BE COVERED
        self.final_path = []
        self.min_dis = min_dis
        self.max_dis = max_dis
        
        ## SETTING UP NODE LENGTHS OF THE PATH
        self.length = length
    ...
    ## SPAWNS THE NODES GENERATED BY RANDOM NODE GENERATOR, THESE NODES CAN OVERLAP WITH THE OBSTACLES BUT WILL NOT BE ADDED TO THE NODE LIST
    ...
    ## SPAWNS ALL THE NODES IN FINAL PATH
    ...
    ## FINAL COURSE ESTABLISHES ALL THE NODES IN THE PATH AND CHECKS IF ALL THE CONDITIONS ARE MET
    ...
    ## CHECKS IF THE NODE IS COLLIDING WITH THE OBSTALCLES
    ...
    ## CHECKS IF A NODE IS SPAWNED IN THE GOAL AREA
    ...
    ## GENERATED THE GOAL PATH FOR FROM THE NODE LIST
    ...
    ## A PRELIMINARY STEP BEFORE GENERATING THE GOAL PATH TO ATTACH ALL THE NEW GENERATED NODES TO A PARENT NODE
    ...
    ## CALCULATE THE NEEDED PARAMETERS BETWEEN TWO NODES
    ...
    ## CALCULATES THE NEAREST NODE OF THE RANDOMLY GENERATED NODE
    ...
    ## CONVERTS SPHERICAL COORDINATES TO PLANAR COORDINATES FOR EASE OF USE IN GAZEBO WORLD
...
## ALL THE FEATURES OF A NODE IN CLASS NODE
...
if __name__ == "__main__":
    ...
    ## CONVERTING OBSTACLE LOCATIONS TO PLANAR COORDINATES
    ...
    ## NUMBER OF ITERATIONS BEFORE THE PLANNER STOPS
    max_iter = 500

    ## OBJECT DEFINITION OF CLASS RRT_PLANNER
    obj = RRT_Planner(min_dis= -10, max_dis=10, obstacle_loc=obstacle_loc, start_point=[0, 0], end_point= [8, 8], length= 2., goal_radius=1.5)
